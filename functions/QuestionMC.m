...
dim1= [Visual.sentPos(1)-10  Visual.sentPos(2)+140  Visual.sentPos(1)+30 Visual.sentPos(2)+180];
dim2= [Visual.sentPos(1)-10  Visual.sentPos(2)+240  Visual.sentPos(1)+30 Visual.sentPos(2)+280];
dim3= [Visual.sentPos(1)-10  Visual.sentPos(2)+340  Visual.sentPos(1)+30 Visual.sentPos(2)+380];
dim4= [Visual.sentPos(1)-10  Visual.sentPos(2)+440  Visual.sentPos(1)+30 Visual.sentPos(2)+480];
